...
export default function Second() {
  ...
  return (
    <>
      <Head>
        <title>The Ultimate Wisdom</title>
      </Head>
      <section className="text-gray-600 body-font -mt-5 ">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
          <div className="pl-10 pr-0 sm:px-2 lg:flex-grow md:w-1/2 lg:pr-24 lg:pl-8 md:pr-16  flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              Supreme (the Ultimate Reality). The Bhagavad Gita consists of 701
              verses by Lord Krishna. It is the dialogues between Pandav Prince
              Arjuna and Lord Krishna during the Kurukshetra war also known as
              Mahabharata.
            </p>
            <div className="p-8 md:p-0 m-1">
              <div className="flex justify-center">
                <div className="">
                  ...
                  >
                    <option value="Please Select Chapter">
                      Choose Chapter
                    </option>
        ...
        <footer className=" flex justify-center mt-0 p-2">
          <div className="flex gap-x-2 items-center justify-center ">
            <a target="_blank" href="https://github.com/viruop">
              <svg
            ...
            <a target="_blank" href="https://www.instagram.com/_viru_7/">
              <svg
                className=" hover:scale-110"
                xmlns="http://www.w3.org/2000/svg"
                width={24}
            ...
            <a
              target="_blank"
              href="https://www.linkedin.com/in/viraj-rai-7b9249230/"
            >
              <svg
                className=" hover:scale-110"
                xmlns="http://www.w3.org/2000/svg"
