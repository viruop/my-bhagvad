      ...
      return (
        ...
        <section className="text-gray-600 body-font -mt-5 ">
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center ">
            <div className="pl-10 pr-0 sm:px-2 lg:flex-grow md:w-1/2 lg:pr-24 lg:pl-4 md:pr-16  flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
